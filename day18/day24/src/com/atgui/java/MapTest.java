 ...
 *                如果equals()返回true：使用value1替换value2.（put具有修改性）
 *
 *
 *           补充：关于情况2和情况3：此时key1-value1和原来的数据以链表的方式存储。
 *
 *           在不断地添加过程中，会涉及到扩容问题，当超出临界值时（且要存放的位置非空），扩容。默认的扩容方式：扩容为原来容量的2倍，并将原有的数据复制过来
 *
 *
 ...
 *  boolean equals(Object obj)：判断当前map和参数对象obj是否相等
    ...
    public void test4(){
        ...
        System.out.println(map.get(45));//key不村子返回null
